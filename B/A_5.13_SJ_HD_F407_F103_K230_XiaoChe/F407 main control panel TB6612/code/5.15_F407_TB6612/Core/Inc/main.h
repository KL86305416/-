...
/* Private defines -----------------------------------------------------------*/
#define Original_Grayscale_1_Pin GPIO_PIN_2
#define Original_Grayscale_1_GPIO_Port GPIOE
#define Original_Grayscale_2_Pin GPIO_PIN_3
#define Original_Grayscale_2_GPIO_Port GPIOE
#define Original_Grayscale_3_Pin GPIO_PIN_4
#define Original_Grayscale_3_GPIO_Port GPIOE
...
#define DJ_PWM_A_Pin GPIO_PIN_2
#define DJ_PWM_A_GPIO_Port GPIOA
#define DJ_AIN2_Pin GPIO_PIN_3
#define DJ_AIN2_GPIO_Port GPIOA
...
#define I2C_OLED_SCL_Pin GPIO_PIN_6
