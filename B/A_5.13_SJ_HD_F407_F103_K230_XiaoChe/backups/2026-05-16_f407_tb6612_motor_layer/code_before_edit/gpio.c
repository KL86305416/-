...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, DJ_AIN2_Pin|OLED_DC_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : DJ_AIN2_Pin OLED_DC_Pin */
  GPIO_InitStruct.Pin = DJ_AIN2_Pin|OLED_DC_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : DJ_BIN2_Pin */
  GPIO_InitStruct.Pin = DJ_BIN2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(DJ_BIN2_GPIO_Port, &GPIO_InitStruct);
