...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, OLED_DC_Pin|DJ_BIN2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, SPI_OLED_CS_Pin|LED_1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, DJ_AIN1_Pin|DJ_AIN2_Pin|DJ_STBY_Pin|DJ_BIN1_Pin
                          |LED_2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : PE2 PE3 PE4 Original_Grayscale_4_Pin
                           Original_Grayscale_5_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_2|GPIO_PIN_3|GPIO_PIN_4|Original_Grayscale_4_Pin
                          |Original_Grayscale_5_Pin;
  ...
  /*Configure GPIO pins : OLED_DC_Pin DJ_BIN2_Pin */
  GPIO_InitStruct.Pin = OLED_DC_Pin|DJ_BIN2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : DJ_AIN1_Pin DJ_AIN2_Pin DJ_STBY_Pin DJ_BIN1_Pin
                           LED_2_Pin */
  GPIO_InitStruct.Pin = DJ_AIN1_Pin|DJ_AIN2_Pin|DJ_STBY_Pin|DJ_BIN1_Pin
                          |LED_2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
