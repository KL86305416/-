...
CONFIGS = (
    {"name": "official", "bgr": False, "byte_swap": False, "hmirror": True, "vflip": True},
    {"name": "swap_only", "bgr": False, "byte_swap": True, "hmirror": True, "vflip": True},
    {"name": "rgb_flip_off", "bgr": False, "byte_swap": False, "hmirror": False, "vflip": False},
    {"name": "swap_flip_off", "bgr": False, "byte_swap": True, "hmirror": False, "vflip": False},
    {"name": "bgr_flip_on", "bgr": True, "byte_swap": False, "hmirror": True, "vflip": True},
    {"name": "bgr_swap_on", "bgr": True, "byte_swap": True, "hmirror": True, "vflip": True},
)
...
def init_lcd(cfg):
    ...
    if cfg["bgr"]:
        kwargs["bgr"] = True
    if cfg["byte_swap"]:
        kwargs["byte_swap"] = True

    lcd = display.SPIDisplay(**kwargs)
    lcd.backlight(1)
    return lcd
